...
function TellMe(joke){
  VoiceRSS.speech({
    key: 'b0da9ad0c25e4c778cac69e916c228f9',
    src: joke,
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
...
async function Jokeapi(){
  try{
    let response=await fetch('https://v2.jokeapi.dev/joke/Any?blacklistFlags=nsfw,religious,political,sexist,explicit&type=single');
